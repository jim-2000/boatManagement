    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(color: widget.bgColor, borderRadius: const BorderRadius.all(Radius.circular(5)), border: Border.all(color: MyColor.textFieldDisableBorderColor)),
