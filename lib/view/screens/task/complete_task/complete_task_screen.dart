      ...
      body: GetBuilder<TaskController>(builder: (controller) {
        return SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              const HeaderText(text: MyStrings.completeTheTask, textStyle: heading),
              Text(
                "Complete your task & get reward".tr,
              ...
              const SizedBox(height: Dimensions.space15),
              const LabelText(text: MyStrings.status),
              Container(
                  ...
                  child: Row(
                    children: List.generate(
                      ...
                      (index) => ZoomTapAnimation(
                        onTap: () {
                          controller.selectStatus(controller.statusList[index]);
                        },
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: controller.selectedStatus == controller.statusList[index] ? Border.all(color: MyColor.colorGrey, width: 1.3) : null,
                          ),
                          child: Text(
              ...
              Align(
                ...
                child: CustomButton(
                  isElevated: true,
                  text: MyStrings.finishJob,
                  press: () {
                    Get.toNamed(RouteHelper.taskFinisheDetailsScreen);
                  },
                  textStyle: semiBoldSmall.copyWith(color: MyColor.colorWhite),
                ),
              )
            ],
          ),
