...
import 'package:flutter_prime/data/controller/withdraw/withdraw_history_controller.dart';
                          ...
                          details?.type=='file'?InkWell(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text((details?.name.toString().capitalizeFirst??'').tr,style: regularDefault.copyWith(color: MyColor.bodyTextColor),overflow: TextOverflow.ellipsis,),
                                const SizedBox(height: 8),
                                Row(
                                  children: [
